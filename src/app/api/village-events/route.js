...
// GET - Fetch village events (all or user-specific)
...
//     if (userId) {
//       const userQuery = `
//         SELECT u.id, u.is_crc, u.is_superuser
//         FROM api_user u
//       `;
...
//       // Check if user is CRC or superuser (required for village events)
//       if (!user.is_crc && !user.is_superuser) {
//         return NextResponse.json(
//           { success: false, message: 'Access denied. Only CRC and superusers can manage village events.' },
//           { status: 403 }
//         );
//       }
...
//         return NextResponse.json(
//           { success: false, message: 'Access denied. You can only view your own events.' },
//           { status: 403 }
//         );
//       }
...
//         WHERE ve.created_by = $1
//         ORDER BY ve.created_at DESC
//       `;
//       params = [userId];
//     } else {
//       // Fetch all active events (for feed)
//       query = `
//         SELECT 
//           ve.id,
//           ve.title,
...
//     });
//   } catch (error) {
//     console.error("GET /api/village-events Error:", error);
//     return NextResponse.json(
//       { error: "Failed to fetch village events", details: error.message }, 
//       { status: 500 }
//     );
//   }
// }
